...
Config.Dispatch = {
    qf_dispatch = true,
    cd_dispatch = false,
    notif_dispatch = false, -- // TriggerClientEvent('qf_mdt:addDispatchAlert', -1, coords, 'title', 'subtitle', 'code f.e. 10-90', 'rgb(255, 0, 255)', '10 - max number of people that can response if you dont want it, set it to 0')
}

...
CALLBACK.RegisterServerCallback = function(name, data)
    ...
    elseif Config.Frameworks.QB.enabled then
        ...
        print('[^2INFO] ^0[^5QF-MDT^0] encountered a problem at [^5RegisterServerCallback^0], if you are using a [^5CUSTOM FRAMEWORK / STANDALONE^0] open a ticket on our discord server and wait for help with configuration!')
